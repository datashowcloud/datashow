...
function initLinkHelp() {
	...
	linkhelp = linkhelp + getLinkHelp('Instance Purchasing Options', 'https://docs.aws.amazon.com/pt_br/AWSEC2/latest/UserGuide/instance-purchasing-options.html', '', '<b>On-demand</b> (Instâncias sob demanda), paga somente pelo uso.<br/><b>Savings Plans</b> é um modelo de preços flexíveis que oferece preços mais baixos em comparação com os preços sob demanda, em troca de um compromisso de uso específico por um período de 1 ou 3 anos)<br/><b> Reserved Instances</b> (Instâncias reservadas), paga por um contrato pré-estabelecido de 1 ou 3 anos de compromisso para obter um grande desconto.<br/><b>Spot Instances</b> (Instâncias spot), paga pelo uso dos recursos não utilizados por outros modelos.<br/><b>Dedicated Hosts</b> (Hosts dedicados).<br/><b>Dedicated Instances</b> (Instâncias dedicadas).<br/><b>Capacity Reservations</b> (Reservas de Capacidade).');
