...
var save = false; //não precisa gravar o restante na tabela porque estão nos arquivos, exemplo: T1C1G11.html
	...
	contadorMycode = String(parseInt(contadorMycode) + 1);
	linkhelp = linkhelp + getLinkHelp(mytema, mycategory, contadorMygroup, contadorMycode, contadorMycode, '', '', '', '', save, 'Suporte', 'https://docs.aws.amazon.com/pt_br/awssupport/latest/user/getting-started.html', 'cinco planos de suporte', 'O AWS Suporte --> Oferece cinco planos de suporte: <br/>1. Basic, <br/>2. Desenvolvedor, <br/>3. Business, <br/>4. Enterprise On-Ramp, <br/>5. Enterprise.<br/><b>Basic, Desenvolvedor, Business</b> (tempo de resposta menor que <u>1 hora</u> com acesso aos engenheiros do Cloud Support por telefone).<br/><b>Enterprise On-Ramp</b> (tempo de resposta menor que <u>30 minutos</u>). <br/><b>Enterprise</b> (tempo de resposta menor que <u>15 minutos</u>).<br/>Todos os planos de suporte oferecem acesso <b>24 horas por dia, 7 dias por semana ao atendimento ao cliente, à documentação da AWS, aos whitepapers e aos fóruns de suporte</b>. <br/><b>Developer</b> tem acesso somente por e-mail em horário comercial. <br/><b>Enterprise e Business</b> fornecem acesso ininterrupto por telefone, e-mail e chat.');
	contadorMycode = String(parseInt(contadorMycode) + 1);
