...
var save = false; //não precisa gravar o restante na tabela porque estão nos arquivos, exemplo: T1C1G11.html
	...
	contadorMycode = String(parseInt(contadorMycode) + 1);
	linkhelp = linkhelp + getLinkHelp(mytema, mycategory, contadorMygroup, contadorMycode, contadorMycode, '', '', '', '', save, 'Suporte', 'https://docs.aws.amazon.com/pt_br/awssupport/latest/user/getting-started.html', 'cinco planos de suporte', 'O AWS Suporte --> Oferece cinco planos de suporte: <br/>1. Basic (menor custo), <br/>2. Developer, <br/>3. Business, <br/>4. Enterprise On-Ramp, <br/>5. Enterprise  (maior custo).<br/><b>Tempo de resposta</b> com acesso aos engenheiros do Cloud Support <b>por telefone</b>: <br/>Basic (menor que 1 hora), <br/>Developer (menor que 1 hora), <br/>Business (menor que 1 hora). <br/>Enterprise On-Ramp (menor que 30 minutos). <br/>Enterprise (menor que 15 minutos). <br/>Todos os planos de suporte oferecem acesso <b>24 horas por dia, 7 dias por semana ao atendimento ao cliente, à documentação da AWS, aos whitepapers e aos fóruns de suporte</b>. <br/><b>Basic, Developer, Business (com acesso aos <b>engenheiros do Cloud Support por telefone</b>) <br/><b>Developer</b> (com acesso somente por <b>e-mail</b> em horário comercial). <br/><b>Enterprise e Business</b> (com acesso ininterrupto por <b>telefone, e-mail e chat</b>).');
	contadorMycode = String(parseInt(contadorMycode) + 1);
