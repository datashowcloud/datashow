...
function initLinkHelp() {
	...
	linkhelp = linkhelp + getLinkHelp('NACL', 'https://docs.aws.amazon.com/pt_br/vpc/latest/tgw/tgw-nacls.html', 'camada opcional de segurança', 'Network ACSs ou NACL (Lista de Controle de Acesso à Rede) é uma camada opcional de segurança. As regras são aplicadas de forma diferente, dependendo do cenário: mesma sub-rede ou sub-redes diferentes.');
