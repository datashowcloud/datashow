...
function initLinkHelp() {
	...
	linkhelp = linkhelp + getLinkHelp('Support', 'https://docs.aws.amazon.com/pt_br/awssupport/latest/user/getting-started.html', 'cinco planos de suporte', 'O AWS Support oferece cinco planos de suporte:Basic,<br/>Desenvolvedor,<br/>Business (tempo de resposta menor que 1 hora),<br/>Enterprise On-Ramp (tempo de resposta menor que 30 minutos),<br/>Enterprise (tempo de resposta menor que 15 minutos),<br/>Todos os planos de suporte oferecem acesso 24 horas por dia, 7 dias por semana ao atendimento ao cliente, à documentação da AWS, aos whitepapers e aos fóruns de suporte.');
	...
	linkhelp = linkhelp + getLinkHelp('SageMaker', 'https://aws.amazon.com/pt/pm/sagemaker/?trk=41368dcc-5040-4349-998b-a9c524544f65&sc_channel=ps&s_kwcid=AL!4422!3!532488969034!e!!g!!aws%20sagemaker&ef_id=EAIaIQobChMI-beq1r7E-gIViCZMCh2PqgFVEAAYASAAEgK2kfD_BwE:G:s&s_kwcid=AL!4422!3!532488969034!e!!g!!aws%20sagemaker', 'machine learning', 'Criar, treinar e implantar modelos de machine learning para qualquer caso de uso com infraestrutura, ferramentas e fluxos de trabalho totalmente gerenciados pela AWS.');
