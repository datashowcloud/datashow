...
function registerEvents() {
    ...
    $('#btnIndexConfigurar').click(function () {
		window.close();
		var DataShow_Config = window.open("config.html?sim=" + document.getElementById('selectMygroup').value, "datashowconfig", "top=0, width=400, height=200, left=500, location=no, menubar=no, resizable=no, scrollbars=no, status=no, titlebar=no, toolbar=no");
...
function setStudentFromImport(mygroup, mycode, myorder, mytext, mycorrect1, mycorrect2, mycorrect3, mycorrect4, myincorrect1, myincorrect2, myincorrect3, myincorrect4) {
