...
//		freezeDataShow(true);
    ...
    $('#selMycodeTextGroup').change(function () {
		...
		if (selectedIndex == '1') { //bíblia
			...
			document.getElementById('txtSearch').value = 'favoritos imagem video';
			refreshTableData();
			showGridAndHideForms();
		} else {
			refreshTableData();
...
//				repeated = valor.substring(posicao, nextpos).indexOf('<repeat>', 0); //próximo separador do texto correspondente a duas quebras de linhas juntas
//				alert(repeated);
//				if (repeated != 0) {
